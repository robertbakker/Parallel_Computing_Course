...
public class Server extends UnicastRemoteObject implements Service {
    ...
    public static String NodeName = "PI11";
    ...
    public static Service connect(String host) {
        return connect(host, DefaultPort);
    }

    public static Service connect(String host, int port) {
    ...
    public <T> T executeTask(Task<T> t) throws RemoteException {
        System.out.println("Executing task: " + t.getClass().getName());
        return t.execute();
    }
